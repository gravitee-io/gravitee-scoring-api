...
public record AssetToAnalyze(
    ...
    @Schema(
        description = "The format of the asset content. Required only to analyze Gravitee API using custom rulesets. Also used for OpenAPI and AsyncAPI custom rulesets."
    )
    Format format
